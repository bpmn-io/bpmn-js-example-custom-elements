...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  function appendEmojiTask(event, element) {
    if (autoPlace) {
      var shape = createEmojiTaskShape(bpmnFactory, elementFactory);

      autoPlace.append(element, shape);
    } else {
      appendEmojiTaskStart(event, element);
    }
  }

  function appendEmojiTaskStart(event, element) {
    var shape = createEmojiTaskShape(bpmnFactory, elementFactory);
...
function createEmojiTaskShape(bpmnFactory, elementFactory) {
